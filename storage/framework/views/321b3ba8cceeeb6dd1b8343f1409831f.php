         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="ukm-list">
                 ...
                 <li>
                   <a href="<?php echo e(url('/about/' . $about->id)); ?>">
                     <img src="<?php echo e(Storage::url($about->logo)); ?>" alt="UKM <?php echo e($about->nama_organisasi); ?>"
                        class="ukm-icon">
                     <?php echo e($about->nama_organisasi); ?>
...
</html><?php /**PATH C:\laragon\www\UKM-TA\resources\views/pages/about.blade.php ENDPATH**/ ?>