        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-indigo rounded-3xl shadow-xl p-10 space-y-8">
                ...
                <div class="flex flex-col md:flex-row items-center md:justify-between gap-6">
                    ...
                    <div class="flex">
                        <a href="<?php echo e(route('tentangkami.edit', $abouts->id)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\UKM-TA\resources\views/tentangkami/index.blade.php ENDPATH**/ ?>