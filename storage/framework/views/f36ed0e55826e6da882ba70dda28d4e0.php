...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 bg-white p-8 shadow rounded">
            ...
            <form action="<?php echo e(route('kegiatanukm.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                ...
                <div class="flex justify-end space-x-2">
                    <a href="<?php echo e(route('kegiatanukm.index')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\UKM-TA\resources\views/kegiatanukm/create.blade.php ENDPATH**/ ?>