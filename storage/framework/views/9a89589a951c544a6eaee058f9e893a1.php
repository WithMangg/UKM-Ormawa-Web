...
<body class="main-layout inner_page">
          ...
          <nav class="navigation navbar navbar-expand-md navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample04">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="<?php echo e(url('/opsi')); ?>">Rekomendasi</a></li>
  ...
  <div class="main-content">
    ...
    <div class="container_opsi">
      <button class="opsi-ukm"><a href="<?php echo e(url('/rekomendasi')); ?>">Organisasi Minat dan Bakat</a></button>
      <button class="opsi"><a href="<?php echo e(url('/ormawa-rekomendasi')); ?>">Organisasi Struktural dan Kelembagaan</a></button>
    </div>
  </div>
...
<?php /**PATH C:\laragon\www\UKM-TA\resources\views/pages/opsirekomendasi.blade.php ENDPATH**/ ?>