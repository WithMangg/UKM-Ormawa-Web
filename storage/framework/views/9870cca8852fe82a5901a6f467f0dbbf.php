...
<head>
   ...
   <link rel="icon" type="image/png" href="/images/logouhn.png">
   <!-- site metas -->
...
<body class="main-layout">
                 ...
                 <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                   <div class="card h-100 border-0 shadow-sm news-box">
                     <img src="<?php echo e(asset('storage/' . $data->foto_kegiatan)); ?>" class="card-img-top"
                       alt="Gambar Berita" style="height: 200px; object-fit: cover;">
                     <div class="card-body d-flex flex-column">
                       <h5 class="card-title text-primary fw-bold"><?php echo e($data->judul); ?></h5>
                       <small class="text-muted mb-2"><?php echo e($data->tanggal_berita); ?></small>
                       <p class="mb-1 fw-medium"><?php echo e($data->deskripsi); ?></p>
                       <p class="text-muted" style="flex-grow: 1;">
                        <?php echo e(Str::limit(strip_tags($data->isi_berita), 100, '...')); ?>

                       </p>
                     </div>
                     <a href="<?php echo e(route('info-berita', $data->id)); ?>" class="btn btn-outline-primary mt-auto">
                       Baca Selengkapnya
                     </a>
                   </div>
                  </div>
         ...
         <div class="row d_flex">
            <div class="col-md-6">
               <div class="titlepage text_align_left">
                  ...
                  <div class="link_btn">
                     <a class="read_more" href=<?php echo e(url('/about')); ?>>Baca selengkapnya</a>
                  </div>
               </div>
            </div>
            <div class="col-md-6">
   ...
   <section class="video-section container mb-5 mt-5">
      ...
      <div class="video-container mx-auto">
         <iframe width="560" height="315" src="https://www.youtube.com/embed/8WPlzqvwS9s"
...
</html><?php /**PATH /home/mangg/Documents/PROJECT/UKM-TA (2)/UKM-TA/resources/views/index.blade.php ENDPATH**/ ?>