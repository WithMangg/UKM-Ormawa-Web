...
<body class="main-layout inner_page">
   ...
   <script>
      function submitForm() {
         ...
         $.ajax({
            url: "<?php echo e(route('recommendations.match')); ?>", // lebih aman pakai route()
            method: 'POST',
            headers: {
...
</html><?php /**PATH C:\laragon\www\UKM-TA\resources\views/pages/rekomendasi.blade.php ENDPATH**/ ?>