...
<?php $component->withAttributes([]); ?>
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl w-1/2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php
                        $labels = [
                            ...
                            'question6' => 'Seberapa sering organisasi ini menyelenggarakan kegiatan atau aktivitas bagi anggotanya?',
                    ...
                    <?php $__currentLoopData = $labels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            ...
                            <select name="<?php echo e($field); ?>" id="edit<?php echo e(ucfirst($field)); ?>" class="w-full border rounded p-2">
...
<?php endif; ?><?php /**PATH C:\laragon\www\UKM-TA\resources\views/ukm/show_recomendation.blade.php ENDPATH**/ ?>