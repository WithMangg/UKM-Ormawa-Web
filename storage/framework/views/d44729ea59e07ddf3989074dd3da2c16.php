...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('kegiatanormawa.create')); ?>" class="bg-indigo-700 text-white px-4 py-2 rounded-full">
                Tambah Foto
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $fotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white p-4 rounded shadow">
                        ...
                        <div class="flex justify-between">
                            ...
                            <form action="<?php echo e(route('kegiatanormawa.destroy', $foto->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus foto ini?')">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\UKM-TA\resources\views/kegiatanormawa/index.blade.php ENDPATH**/ ?>